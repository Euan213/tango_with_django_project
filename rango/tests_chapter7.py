...
class Chapter7PageFormAncillaryTests(TestCase):
    ...
    def test_add_page_url_mapping(self):
        ...
        self.assertEqual(resolved_url, '/rango/category/python/add_page/', f"{FAILURE_HEADER}The lookup of URL name 'rango:add_page' didn't return a URL matching '/rango/category/python/add_page/', when using category 'python'. Check you have the correct mappings and URL parameters, and try again.{FAILURE_FOOTER}" + "*" + resolved_url + "*")
